...
```{r}
# TODO: Ajouter duckduck go, thereisaniaforthat, deepseek, qwen groq, groK, montrer les IAs que j'utilise (perplexity, Quillbot, Elicit, GitHub copilot)
```
...
```{r}
# TODO: commencé par les compétiteurs de OpenAI, puis thereisanaiforthat, puis ceux ceux que j'utilise (sans les locaux)
```
